                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className={`w-full px-4 py-2 rounded-md border ${errors.email ? 'border-red-500' : 'border-orange-200 dark:border-orange-300'
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={handleChange}
                                className={`w-full px-4 py-2 rounded-md border ${errors.password ? 'border-red-500' : 'border-orange-200 dark:border-orange-300'
                                    } bg-white dark:bg-neutral-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-orange-500`}
                            />
